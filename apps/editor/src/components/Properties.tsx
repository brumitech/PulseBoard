...
// Helper functions for color conversion (kept from original)
                  ...
                  {prop.type === 'color' ? (
                    <div className="flex items-center space-x-2 flex-1">
                      ...
                      <Input
                        ...
                        className="flex-1 bg-gray-800 border-gray-600 text-black placeholder-gray-500 focus:border-blue-500 focus:ring-blue-500 focus:ring-opacity-50 focus-visible:ring-offset-gray-800"
                      />
                    </div>
                  ) : (
                    <Input
